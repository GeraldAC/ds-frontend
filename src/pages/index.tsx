...
const IndexPage = () => {
  ...
  return (
    <Box>
          ...
          <VStack spacing={8} textAlign="center">
            ...
            <VStack spacing={4}>
              ...
              <Text
                ...
                lineHeight="1.8"
              >
                Descubre productos <strong>orgánicos</strong> y <strong>sostenibles</strong> 
                directamente de productores locales del valle sagrado de Cusco
              </Text>
            </VStack>
            ...
            {[
              {
                icon: Leaf,
                title: "100% Orgánico",
                description: "Productos cultivados sin químicos, respetando la naturaleza",
                color: "green"
              },
              {
                icon: Heart,
                title: "Comercio Justo",
                description: "Precios justos directamente del productor al consumidor",
                color: "orange"
              },
              {
                icon: Users,
                title: "Comunidad Local",
                description: "Apoyamos a familias productoras del valle sagrado",
                color: "brown"
              }
            ].map((value, index) => (
              <Card
      ...
      {/* Lista de productos */}
      <Box py={12} bg="gray.50" id="productos-section">
        <Container maxW="6xl">
          <VStack spacing={8}>
